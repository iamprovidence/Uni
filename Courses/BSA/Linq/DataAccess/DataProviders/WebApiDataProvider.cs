...
{
    public class WebApiDataProvider : Interfaces.IDataProvider
    {
        // CONSTS
        static readonly string URL_FORMAT = "https://bsa2019.azurewebsites.net/api/{0}";

        // FIELDS
        static WebApiDataProvider instance;
        ...
        {
            instance = new WebApiDataProvider();
        }
        ~WebApiDataProvider()
        {
            httpClient.Dispose();
        ...
        // PROPERTIES
        public static WebApiDataProvider Instance => instance;
