...
namespace Client
{
    class Menu : IDisposable
    {
        ...
        public void Run()
        {
            while (!exit)
            {
                ...
                catch (AggregateException ex)
                {
                    ...
                    Console.WriteLine("Server may not be running");
                    Console.ReadLine();
                }
            }
        }
        ...
        private void DeleteTaskById()
        {
            ...
            // delete
            serviceManager.TaskService.DeleteTask(taskId);
        }
        private void CreateRandomTask()
        {
            serviceManager.TaskService.CreateTask(CrateRandomTaskDTO());
        }
        public Core.DataTransferObjects.Task.CreateTaskDTO CrateRandomTaskDTO()
        {
            return new Core.DataTransferObjects.Task.CreateTaskDTO
            {
                ...
                FinishedAt = DateTime.Now.AddYears(1),

                PerformerId = random.Next(50),
        ...
        {
            serviceManager.TeamService.CreateTeam(new Core.DataTransferObjects.Team.CreateTeamDTO
            {
        ...
        private void RenameTeam()
        {
            ...
            // rename
            serviceManager.TeamService.RenameTeam(new Core.DataTransferObjects.Team.RenameTeamDTO
            {
                Id = teamId,
                Name = teamName
            });
        ...
        private void DeleteTeam()
        {
            ...
            // delete
            serviceManager.TeamService.DeleteTeam(teamId);
        }
        #endregion
        ...
        {
            serviceManager.UserService.Create(CreateRandomUser());
        }
        ...
        private void DeleteUser()
        {
            ...
            // delete
            serviceManager.UserService.Delete(userId);
        }
        #endregion
        ...
        {
            serviceManager.ProjectService.Create(CreateRandomProject());
        }
        ...
        private void DeleteProject()
        {
            ...
            // delete
            serviceManager.ProjectService.Delete(projectId);
        }
        #endregion
        ...
        {
            // color
            Console.ForegroundColor = e.SerializationResult.IsSuccessed ? ConsoleColor.Green : ConsoleColor.Red;

            // message
            Console.WriteLine(e.SerializationResult.Message);
