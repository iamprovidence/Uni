...
{
    [TestClass]
    public class BothIncreasingMultiplyCannon
    {
        Matrix.MultiplyStyle MULTIPLY_STYLE = Matrix.MultiplyStyle.Cannon;
        [TestMethod]
        public void CS_Multiply_Cannon_SizeMiddle_ThreadBig()
        {
        ...
        [TestMethod]
        public void CS_Multiply_Cannon_SizeMiddle_ThreadMiddle()
        {
            const int SIZE = Tester.MULTIPLY_SIZE_MIDDLE;
        ...
        [TestMethod]
        public void CS_Multiply_Cannon_SizeBig_ThreadBig()
        {
