...
{
    [TestClass]
    public class ThreadIncreasingMultiplyTape
    {
        Matrix.MultiplyStyle MULTIPLY_STYLE = Matrix.MultiplyStyle.Tape;
        [TestMethod]
        public void CS_Multiply_Tape_SizeSmall_ThreadMiddle()
        {
        ...
        [TestMethod]
        public void CS_Multiply_Tape_SizeSmall_ThreadBig()
        {
            const int SIZE = Tester.MULTIPLY_SIZE_SMALL;
        ...
        [TestMethod]
        public void CS_Multiply_Tape_SizeBig_ThreadMiddle()
        {
